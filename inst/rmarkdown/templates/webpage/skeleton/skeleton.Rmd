...
knitr::opts_chunk$set(echo = FALSE, eval = TRUE, out.width = '100%', fig.pos = "H", out.extra = "", fig.show='hold', fig.align='left')
```
...
```
![This captino describes an image.](images/image_name.jpg)
```
