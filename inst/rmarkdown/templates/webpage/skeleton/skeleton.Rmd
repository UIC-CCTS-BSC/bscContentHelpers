...
A new output directory will be created, containing a copy of this .Rmd file (renamed `_index.Rmd`) and subfolders for supporting documents. 
...
* In the page bundle, this .Rmd source file will be renamed `_index.Rmd`.
...
![This picture shows a kitten.](images/kitten.jpg)

If you want to number and cross-reference your images or have more control over how they're displayed, insert them as R code chunks instead. Be sure to give each code chunk a unique label and a caption, as in Figure \@ref(fig:two-kittens):

```{r two-kittens, fig.cap = "More kittens.", out.width="33%"}
knitr::include_graphics("images/two_kittens.jpg")
```
