...
<!-- IMPORTANT: This document originated outside the `ccts-wiki-geekdocs-theme` GitHub repository. Don't edit this page directly on the website; instead, check the `bscContent` repository to see if there's a source file that needs to be updated. -->
...
```{r, include=FALSE, eval = knitr::is_html_output()}
# image width for web pages [only applies to images inserted with knitr::include_graphics()]
